...
export default function MealsPage() {
  ...
  const loadScheduledMeals = async () => {
    try {
      ...
      const { data } = await api.meals.list({ startDate: tomorrowStr });
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Your scheduled meals from tomorrow onwards</CardDescription>
                </div>
                <Button
                  variant="outline"
                  size="sm"
                ...
                <div className="space-y-4 max-h-[600px] overflow-y-auto">
                  {scheduledMeals.length === 0 ? (
                    ...
                    (() => {
                      ...
                      return Object.entries(grouped).map(([mealType, mealsInGroup]) => {
                        ...
                        const upcomingMeals = mealsInGroup.filter(m => m.status === 'ACTIVE');
